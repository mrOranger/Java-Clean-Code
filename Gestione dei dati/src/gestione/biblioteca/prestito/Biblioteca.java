...
public class Biblioteca {
	...
	public void registraStudente(String nome, String cognome, LocalDate dataNascita) {
		Studente nuovoStudente;
		try {
			nuovoStudente = new Studente(nome, cognome, dataNascita);
			this.registroStudenti.add(nuovoStudente);
		} catch (NomeNonValidoException | DataNonValidaException e) {
